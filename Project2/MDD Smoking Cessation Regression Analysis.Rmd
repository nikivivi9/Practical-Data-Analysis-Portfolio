...
# Combine for final ordered result
ordered_model_results_nontrans <- rbind(main_effects_nontrans, interaction_terms_nontrans)[-4,]
...
grid.arrange(rasterGrob(bootstrap_roc_image), rasterGrob(bootstrap_calibration_image),ncol = 2)
grid.text("Bootstrap Lasso Validation", x = 0.5, y = 0.85, gp = gpar(fontsize = 12))
